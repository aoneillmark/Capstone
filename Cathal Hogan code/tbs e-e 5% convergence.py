# -*- coding: utf-8 -*-
"""
Created on Tue Oct  3 10:43:53 2023
...
parameters = dict(
    order=3, # CCE order
    r_bath=80,  # Size of the bath in A
...
orders.plot(title='convergence test for orders; cell=100; nbstates=250; [?:80:60]',
           xlabel='order', ylabel='Coherence')
#plt.show() #uncomment to see individually

#converge for r_bath
rbs = runner('r_bath', [60,80,100])
orders.plot(title='convergence test for r_bath; cell=100; nbstates=250; [3:?:60]',
           xlabel='order', ylabel='Coherence')
#plt.show() #uncomment to see individually

#converge for r_dipole
rds = runner('r_dipole', [40,60,80])
orders.plot(title='convergence test for r_dipole; cell=100; nbstates=250; [3:80:?]',
           xlabel='order', ylabel='Coherence')
#plt.show() #uncomment to see individually
...
plt.suptitle('Convergence tests; cell = 100copies')
fig.tight_layout()
