# -*- coding: utf-8 -*-
"""
Created on Tue Oct  3 11:59:26 2023
...
sic.isotopes['V']['51V'] = 0.5 #set to 50%
...
orders.plot(title='convergence test for orders; cell=400; nbstates=0; [?:200:80]',
           xlabel='order', ylabel='Coherence')
#plt.show() # uncomment to show individually

#converge for r_bath
rbs = runner('r_bath', [500,100,200])
orders.plot(title='convergence test for r_bath; cell=400; nbstates=0; [2:?:80]',
           xlabel='order', ylabel='Coherence')
#plt.show() # uncomment to show individually

#converge for r_dipole
rds = runner('r_dipole', [60,80,100])
orders.plot(title='convergence test for r_dipole; cell=400; nbstates=0; [2:100:?]',
           xlabel='order', ylabel='Coherence')
#plt.show() # uncomment to show individually
