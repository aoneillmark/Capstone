# -*- coding: utf-8 -*-
"""
Created on Tue Oct  3 12:02:31 2023
...
plt.title('50 coherence curves for n-e 50% cell=200 [2:100:80]')
plt.show()
...
plt.xlabel('Time [ms]')
plt.ylabel('Coherence')
plt.title('Averaged Coherence Curve n-e 50%')
plt.show()

#fit coherence curve 
p_guess= [0.01, 2] #guessing T2 and the power respectively 
