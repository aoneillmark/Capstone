# -*- coding: utf-8 -*-
"""
Created on Tue Oct  3 10:52:57 2023
...
orders.plot(title='convergence test for orders; cell=180; nbstates=100; [?:60:40]',
           xlabel='order', ylabel='Coherence')
#plt.show() #uncomment to see individually

#converge for r_bath
rbs = runner('r_bath', [40,60,80])
orders.plot(title='convergence test for r_bath; cell=180; nbstates=100; [3:?:40]',
           xlabel='order', ylabel='Coherence')
#plt.show() #uncomment to see individually

#converge for r_dipole
rds = runner('r_dipole', [20,40,60])
orders.plot(title='convergence test for r_dipole; cell=180; nbstates=100; [3:60:?]',
           xlabel='order', ylabel='Coherence')
#plt.show() #uncomment to see individually
...
plt.suptitle('Convergence tests; cell = 180copies')
fig.tight_layout()


#converge for cell size 
ls_cell = [] #empty list to collect simulations 
cell_size = [100,180,200] #enter cell sizes to be simulated 
for i in cell_size:
    #generate cell
