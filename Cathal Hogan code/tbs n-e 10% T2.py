# -*- coding: utf-8 -*-
"""
Created on Tue Oct  3 11:46:44 2023
...
ts = np.linspace(0, 1e-1, 201) #expected T2 of 0.02
cell = 400 #cell size 
...
plt.title('50 coherence curves for n-e 10% cell=400 [2:200:180]')
plt.show()
...
plt.xlabel('Time [ms]')
plt.ylabel('Coherence')
plt.title('Averaged Coherence Curve n-e 10%')
plt.show()
