# -*- coding: utf-8 -*-
"""
Created on Tue Oct  3 11:48:48 2023
...
orders.plot(title='convergence test for orders; cell=400; nbstates=0; [?:200:150]',
           xlabel='order', ylabel='Coherence')
#plt.show() # uncomment to show individually

#converge for r_bath
rbs = runner('r_bath', [100,200,300])
orders.plot(title='convergence test for r_bath; cell=400; nbstates=0; [2:?:150]',
           xlabel='order', ylabel='Coherence')
#plt.show() # uncomment to show individually

#converge for r_dipole
rds = runner('r_dipole', [100,150,200])
