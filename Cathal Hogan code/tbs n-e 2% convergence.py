# -*- coding: utf-8 -*-
"""
Created on Sun Aug 27 09:53:02 2023
...
ts = np.linspace(0, 5e-1, 201) #T2 =1us for 2% concentration
...
#converge for order 
orders = runner('order', [1,2]) #problems running order 3
orders.plot(title='convergence test for orders; cell=500; nbstates=0; [?:200:180]',
           xlabel='order', ylabel='Coherence')
#plt.show() # uncomment to show individually

#converge for r_bath
rbs = runner('r_bath', [100,200,300])
orders.plot(title='convergence test for r_bath; cell=500; nbstates=0; [2:?:180]',
           xlabel='order', ylabel='Coherence')
#plt.show() # uncomment to show individually

#converge for r_dipole
rds = runner('r_dipole', [100,180,200])
orders.plot(title='convergence test for r_dipole; cell=500; nbstates=0; [2:200:?]',
           xlabel='order', ylabel='Coherence')
#plt.show() # uncomment to show individually
...
plt.suptitle('Convergence tests; cell = 500copies')
fig.tight_layout()

#converge for cell size 
ls_cell = [] #empty list to collect simulations 
cell_size = [300,500,600] #enter cell sizes to be simulated 
for i in cell_size():
    #generate cell
