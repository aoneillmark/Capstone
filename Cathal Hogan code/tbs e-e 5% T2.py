# -*- coding: utf-8 -*-
"""
Created on Tue Oct  3 10:47:27 2023
...
sic.isotopes['V']['51V'] = 0.05 #set to 2%
...
plt.title('50 coherence curves for e-e 5%')
plt.show()
...
plt.xlabel('Time [ms]')
plt.ylabel('Coherence')
plt.title('Averaged Coherence Curve e-e 5%')
plt.show()

#fit coherence curve 
p_guess= [0.002, 2] #guessing T2 and the power respectively 
