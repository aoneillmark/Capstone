# # -*- coding: utf-8 -*-
# """
# Created on Tue Oct  3 10:57:51 2023
...
#parameters
nb = 100
ts = np.linspace(0, 0.001, 201) #expected T2 of 3.3e-2
cell = 180 #cell size 
...
plt.title('50 coherence curves for e-e 10%')
plt.show()
...
plt.xlabel('Time [ms]')
plt.ylabel('Coherence')
plt.title('Averaged Coherence Curve e-e 10%')
plt.show()

#fit coherence curve 
p_guess= [0.0003, 2] #guessing T2 and the power respectively 
